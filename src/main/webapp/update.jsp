        ...
        <form action="Update" method="POST">
          <div class="form-group">
            ...
            <input type="text" class="form-control bg-dark" id="exampleInputName" aria-describedby="emailHelp"
              placeholder="Username" style="color: white;" name="organization_name" value="<%=user.getName() %>" />
            <br />
            <br />


            <input type="text" class="form-control bg-dark" id="exampleInputName" aria-describedby="emailHelp"
              placeholder="Email" style="color: white;" name="organization_email" value="<%= user.getEmail() %>" />
            <br />
            <br />
