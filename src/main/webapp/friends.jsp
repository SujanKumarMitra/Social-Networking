      ...
      <div class="col-sm-6">
        <h3 style="margin-bottom: 40px; color:orange">
          <table>
            ...
            <tr>
              <td><a
                  href='friend_profile.jsp?friend_id=<%= user.getId() %>&friend_name=<%=user.getName() %>&friend_email=<%=user.getEmail() %>'
                  style='text-decoration: none;  color:orange'><%=user.getName() %></a></td>
              <td><a
                  href='friend_profile.jsp?friend_id=<%= user.getId() %>&friend_name=<%=user.getName() %>&friend_email=<%=user.getEmail() %>'
                  style='text-decoration: none;  color:orange'><%= user.getEmail() %></td>
